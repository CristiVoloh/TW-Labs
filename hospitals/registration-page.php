	    ...
	    <div class="main-content">
            ...
            <div class="form-section" data-aos="fade-up">
                <div class="form-body">
	    			...
	    			<form action="registration-page.php" id="registration" name="registration" method="POST">
	    				<input class="input" type="text" id="name" name="name" placeholder="Numele" required data-aos="fade-up">
						<input class="input" type="text" id="secondName" name="secondName" placeholder="Prenumele" required data-aos="fade-up">
	    				<input class="input" type="text" id="email" name="email" placeholder="E-Mail" required data-aos="fade-up">
	    				<input class="input" type="password" id="password" name="password" placeholder="Password" required data-aos="fade-up">
	    				<input class="input" type="password" id="cpassword" name="cpassword" placeholder="Verify password" required data-aos="fade-up">
						<br>
						<div class="error" style="text-align: center;"></div>
						<div class="success" style="text-align: center;"></div>
						<button type="submit" id="submit" name="register" class="primary-button registration-button" data-aos="fade-up">Register</button>
    				</form>
	    			<p>Don't have an account? <a href="login-page.php" class="register_open_pop_up" data-aos="fade-up">Login</a></p>
	    		</div>
            </div>
